...
import styles from "./LaboratorioModal.module.scss";
...
function LaboratorioModal({
  ...
  const onExclude = async () => {
    try {
      ...
      await exameLaboratorias.deleteExameLaboratoriais(patientData?.id);
    ...
    >
      <DialogContent style={{ overflowX: "hidden" }}>
        <div className={styles.headerConsulta}>
          <span className={styles.titleSection}>Exame</span>
